 ...
 * Table28sFixture
 */
class Table28sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 28', 'precision' => null, 'comment' => null, 'collate' => null],
