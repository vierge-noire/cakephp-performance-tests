 ...
 * Table16sFixture
 */
class Table16sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 16', 'precision' => null, 'comment' => null, 'collate' => null],
