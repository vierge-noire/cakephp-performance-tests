 ...
 * Table19sFixture
 */
class Table19sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 19', 'precision' => null, 'comment' => null, 'collate' => null],
