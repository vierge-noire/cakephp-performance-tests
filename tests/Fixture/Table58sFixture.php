 ...
 * Table58sFixture
 */
class Table58sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 58', 'precision' => null, 'comment' => null, 'collate' => null],
