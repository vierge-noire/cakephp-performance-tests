 ...
 * Table90sFixture
 */
class Table90sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 90', 'precision' => null, 'comment' => null, 'collate' => null],
