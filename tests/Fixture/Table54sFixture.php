 ...
 * Table54sFixture
 */
class Table54sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 54', 'precision' => null, 'comment' => null, 'collate' => null],
