 ...
 * Table41sFixture
 */
class Table41sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 41', 'precision' => null, 'comment' => null, 'collate' => null],
