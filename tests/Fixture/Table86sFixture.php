 ...
 * Table86sFixture
 */
class Table86sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 86', 'precision' => null, 'comment' => null, 'collate' => null],
