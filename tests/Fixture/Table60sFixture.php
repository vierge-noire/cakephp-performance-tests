 ...
 * Table60sFixture
 */
class Table60sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 60', 'precision' => null, 'comment' => null, 'collate' => null],
