 ...
 * Table40sFixture
 */
class Table40sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 40', 'precision' => null, 'comment' => null, 'collate' => null],
