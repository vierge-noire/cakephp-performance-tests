 ...
 * Table75sFixture
 */
class Table75sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 75', 'precision' => null, 'comment' => null, 'collate' => null],
