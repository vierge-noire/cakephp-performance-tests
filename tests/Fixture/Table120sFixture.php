 ...
 * Table120sFixture
 */
class Table120sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 120', 'precision' => null, 'comment' => null, 'collate' => null],
