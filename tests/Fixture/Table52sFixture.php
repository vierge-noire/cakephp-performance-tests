 ...
 * Table52sFixture
 */
class Table52sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 52', 'precision' => null, 'comment' => null, 'collate' => null],
