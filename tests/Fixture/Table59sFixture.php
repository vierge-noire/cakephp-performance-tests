 ...
 * Table59sFixture
 */
class Table59sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 59', 'precision' => null, 'comment' => null, 'collate' => null],
