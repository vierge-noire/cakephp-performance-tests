 ...
 * Table117sFixture
 */
class Table117sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 117', 'precision' => null, 'comment' => null, 'collate' => null],
