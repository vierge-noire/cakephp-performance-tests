 ...
 * Table15sFixture
 */
class Table15sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 15', 'precision' => null, 'comment' => null, 'collate' => null],
