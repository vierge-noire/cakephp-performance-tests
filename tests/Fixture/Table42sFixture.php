 ...
 * Table42sFixture
 */
class Table42sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 42', 'precision' => null, 'comment' => null, 'collate' => null],
