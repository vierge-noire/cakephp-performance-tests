 ...
 * Table37sFixture
 */
class Table37sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 37', 'precision' => null, 'comment' => null, 'collate' => null],
