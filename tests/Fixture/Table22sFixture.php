 ...
 * Table22sFixture
 */
class Table22sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 22', 'precision' => null, 'comment' => null, 'collate' => null],
