 ...
 * Table47sFixture
 */
class Table47sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 47', 'precision' => null, 'comment' => null, 'collate' => null],
