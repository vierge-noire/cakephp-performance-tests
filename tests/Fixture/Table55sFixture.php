 ...
 * Table55sFixture
 */
class Table55sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 55', 'precision' => null, 'comment' => null, 'collate' => null],
