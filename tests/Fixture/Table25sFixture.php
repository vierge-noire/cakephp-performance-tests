 ...
 * Table25sFixture
 */
class Table25sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 25', 'precision' => null, 'comment' => null, 'collate' => null],
