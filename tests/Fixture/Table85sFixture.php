 ...
 * Table85sFixture
 */
class Table85sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 85', 'precision' => null, 'comment' => null, 'collate' => null],
