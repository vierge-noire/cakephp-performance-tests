 ...
 * Table18sFixture
 */
class Table18sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 18', 'precision' => null, 'comment' => null, 'collate' => null],
