 ...
 * Table74sFixture
 */
class Table74sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 74', 'precision' => null, 'comment' => null, 'collate' => null],
