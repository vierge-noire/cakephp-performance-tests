 ...
 * Table78sFixture
 */
class Table78sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 78', 'precision' => null, 'comment' => null, 'collate' => null],
