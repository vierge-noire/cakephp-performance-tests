 ...
 * Table180sFixture
 */
class Table180sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 180', 'precision' => null, 'comment' => null, 'collate' => null],
