 ...
 * Table264sFixture
 */
class Table264sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 264', 'precision' => null, 'comment' => null, 'collate' => null],
