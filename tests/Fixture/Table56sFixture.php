 ...
 * Table56sFixture
 */
class Table56sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 56', 'precision' => null, 'comment' => null, 'collate' => null],
