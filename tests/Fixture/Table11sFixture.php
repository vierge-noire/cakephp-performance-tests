 ...
 * Table11sFixture
 */
class Table11sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 11', 'precision' => null, 'comment' => null, 'collate' => null],
