 ...
 * Table296sFixture
 */
class Table296sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 296', 'precision' => null, 'comment' => null, 'collate' => null],
