 ...
 * Table24sFixture
 */
class Table24sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 24', 'precision' => null, 'comment' => null, 'collate' => null],
