 ...
 * Table94sFixture
 */
class Table94sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 94', 'precision' => null, 'comment' => null, 'collate' => null],
