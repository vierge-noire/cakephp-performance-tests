 ...
 * Table145sFixture
 */
class Table145sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 145', 'precision' => null, 'comment' => null, 'collate' => null],
