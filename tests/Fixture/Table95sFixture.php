 ...
 * Table95sFixture
 */
class Table95sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 95', 'precision' => null, 'comment' => null, 'collate' => null],
