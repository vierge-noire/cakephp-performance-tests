 ...
 * Table45sFixture
 */
class Table45sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 45', 'precision' => null, 'comment' => null, 'collate' => null],
