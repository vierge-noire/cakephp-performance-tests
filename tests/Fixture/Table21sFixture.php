 ...
 * Table21sFixture
 */
class Table21sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 21', 'precision' => null, 'comment' => null, 'collate' => null],
