 ...
 * Table150sFixture
 */
class Table150sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 150', 'precision' => null, 'comment' => null, 'collate' => null],
