 ...
 * Table266sFixture
 */
class Table266sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 266', 'precision' => null, 'comment' => null, 'collate' => null],
