 ...
 * Table242sFixture
 */
class Table242sFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => 'Default name for table 242', 'precision' => null, 'comment' => null, 'collate' => null],
